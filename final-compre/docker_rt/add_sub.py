...
SUBJECT_DIR = BASE_DIR / "subjects_img" / "Autobits_emp"
SUBJECT_DIR = BASE_DIR / "subjects_img" / "Hathi_pic" 
...
SQLALCHEMY_DATABASE_URI = os.getenv("SQLALCHEMY_DATABASE_URI","postgresql+psycopg2://postgres:postgres@localhost:6432/frs")
